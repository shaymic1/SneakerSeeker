...
def main(debug_input=None) -> None:
    ...
    for scenario_json_path in args["scenarios"]:
        ...
        vid_path = utils.make_video(
            frames_dir=out_path, frames_format=args["frames_format"], video_name=f"{scenario['name']}.avi",
...
if __name__ == "__main__":
    debug = [
        "--scenarios",
        r"C:\Users\shali\OneDrive\code\python\SneakerSeeker\sneaker_seeker_app\scenarios\scenario01.json",
